    ...
    <el-row>
      <el-col :span="4">
        <div class="grid-content bg-purple">
          ...
          <br>
          <el-tooltip content="<i class='iconfont icon-zixun-tousu'></i>" placement="top">
            <span>icon-zixun-tousu</span>
          </el-tooltip>
        </div>
      </el-col>
      <el-col :span="4">
        <div class="grid-content bg-purple">
          ...
          <br>
          <el-tooltip content=" <i class='iconfont icon-tubiao1'></i>" placement="top">
      ...
      <el-col :span="4">
        <div class="grid-content bg-purple">
          ...
          <br>
          <el-tooltip content="<i class='iconfont icon-xinwen1'></i>" placement="top">
      ...
      <el-col :span="4">
        <div class="grid-content bg-purple">
         <i class='iconfont icon-quanxian'></i>
          <br>
          <el-tooltip content=" <i class='iconfont icon-quanxian'></i>" placement="top">
      ...
      <el-col :span="4">
        <div class="grid-content bg-purple">
         <i class='iconfont icon-zhengjian1'></i>
          <br>
          <el-tooltip content=" <i class='iconfont icon-zhengjian1'></i>" placement="top">
      ...
      <el-col :span="4">
        <div class="grid-content bg-purple">
          ...
          <br>
          <el-tooltip content="<i class='iconfont icon-ziliao'></i>" placement="top">
      ...
      <el-col :span="4">
        <div class="grid-content bg-purple">
          ...
          <br>
          <el-tooltip content="<i class='iconfont icon-shizhong'></i>" placement="top">
      ...
      <el-col :span="4">
        <div class="grid-content bg-purple">
          ...
          <br>
          <el-tooltip content="<i class='iconfont icon-shibai'></i>" placement="top">
